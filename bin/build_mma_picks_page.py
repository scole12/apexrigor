...
def main() -> int:
  ...
  <main class="picks-page">
    ...
    <div class="rationale-copy"><p id="forecast-copy">Forecasts publish at T-2 only when the current scientific release and event inputs pass the production checks.</p></div>
