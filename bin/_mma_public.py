#!/usr/bin/env python3
"""Shared deterministic HTML fragments for the namespaced APEX MMA preview."""
...
def navigation(active: str) -> str:
    sport = """  <nav class=\"nav sport-switcher\" aria-label=\"Sport\">
    <a href=\"/\">MLB</a>
    <a href=\"/ncaaf\">NCAA</a>
    <a href=\"/mma\" class=\"active\">MMA</a>
  </nav>"""
    links = (
        ("PICKS", "/mma"),
        ("RESULTS", "/mma/results"),
