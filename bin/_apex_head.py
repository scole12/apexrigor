...
CACHE_VER = "apex-20260518-picks-mobile"


def get_head_block(page_title: str, page_path: str = "/", page_desc: str = "") -> str:
    ...
    page_desc:  short description for OG/Twitter cards
    """
    if not page_desc:
        page_desc = "APEX Quantitative Forecasting — walk-forward validated multi-sport models."
